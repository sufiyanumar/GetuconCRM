$(function (e) {
	'use strict'
	initTicketGraph('monthly');
	$('.graphButton').on('click', function () {
		var timeLine = $(this).attr('data-id');
		initTicketGraph(timeLine);
	})
	function initTicketGraph(timeLine) {
		$.ajax({
			method: 'GET',
			url: '/getTicketsGraphData?timeLine=' + timeLine,
