            ...
            return DataTables::of($users)
                ->addColumn('actions', function ($users) {
                    if (in_array('UPDATE_USER', auth()->user()->Permissions) && in_array('DELETE_USER', auth()->user()->Permissions))
                        return '<a href="' . url('/update-user' . '/' . $users->id) . '"><i class="fa fa-pencil btn btn-warning"></i></a> <a href="#" data-id="' . $users->id . '" class="deleteUser"><i class="fa fa-trash btn btn-danger"></i></a>';
                    if (!in_array('UPDATE_USER', auth()->user()->Permissions) && in_array('DELETE_USER', auth()->user()->Permissions))
