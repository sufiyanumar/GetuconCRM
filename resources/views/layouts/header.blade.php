									...
									<div class="d-flex order-lg-2 ml-auto">
										...
										<div class="dropdown profile-dropdown">
											<a href="{{url('/' . $page='#')}}" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="https://ui-avatars.com/api/?name={{auth()->user()->first_name}} {{auth()->user()->surname}}&background=5E72E4&color=fff&size=40" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="{{url('/' . $page='dashboard')}}" class="dropdown-item text-center user pb-0 font-weight-bold">{{auth()->user()->first_name}} {{auth()->user()->surname}}</a>
